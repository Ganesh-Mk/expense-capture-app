...
const adminNav = [
  ...
  { to: "/admin/rules", label: "Rules & Limits", icon: Sliders },
  { to: "/expenses/new", label: "New Expense", icon: PlusCircle },
  { to: "/expenses", label: "My Expenses", icon: ReceiptText },
  { to: "/chat", label: "Chat Support", icon: MessageSquare },
];
...
export default function AppLayout() {
  ...
  return (
    <div className="flex h-svh bg-background">
      {/* Desktop Sidebar */}
      <aside className="hidden h-screen w-56 shrink-0 border-r bg-card/50 md:flex md:flex-col">
        {/* Brand */}
